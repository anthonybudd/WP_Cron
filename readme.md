...
The WordPress con API is very verbose and equaly as unuserfrienly. WP_Cron is a simple class that you can extend to make really simple custom cron events.
